...
using MatC   = Eigen::Matrix<CT, Eigen::Dynamic, Eigen::Dynamic>;
...
TEST_CASE("Test MatrixCI1 - float128", "[matrix_ci1]")
{
    SECTION("fixed rank")
    {
        int n = 100, rank = 50;
...
TEST_CASE("Test MatrixCI1 complex - float128", "[matrix_ci1]")
{
...
TEST_CASE("Test MatrixCI2 - float128", "[matrix_ci2]")
{
    SECTION("fixed rank")
    {
        int n = 100, rank = 50;
...
TEST_CASE("Test CrossData - float128", "[cross]")
{
...
TEST_CASE("Test RRLUDecomp - float128", "[rrlu]")
{
    SECTION("2x3 matrix") {
        Mat A(2, 3);
        A << 1, 2, 3, 4, 5, 6;
...
TEST_CASE("Test CURDecomp - float128", "[cur]")
{
    SECTION("2x3 matrix") {
        Mat A(2, 3);
        A << 1, 2, 3, 4, 5, 6;
...
TEST_CASE("Test ARRLUDecomp - float128", "[arrlu]")
{
...
TEST_CASE("Test SVDDecomp - float128", "[svd]")
{
    SECTION("2x3 matrix") {
        Mat A(2, 3);
        A << 1, 2, 3, 4, 5, 6;
