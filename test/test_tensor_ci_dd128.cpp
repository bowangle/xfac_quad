...
const Real ci_tol2   = Real(10000) * std::numeric_limits<Real>::epsilon();
...
// CI1 Tests
// ============================================================
TEST_CASE("TensorCI1 basic - dd128", "[ci1]")
{
...
TEST_CASE("TensorCI1 basic - complex dd128", "[ci1]")
{
    SECTION("rank-1 separable function")
    {
...
// CI2 Tests
// ============================================================
TEST_CASE("TensorCI2 basic - dd128", "[ci2]")
{
    SECTION("rank-1 separable function")
    {
        auto myf = [](std::vector<int> const& id) -> T {
...
TEST_CASE("TensorCI2 basic - complex dd128", "[ci2]")
{
    SECTION("rank-1 separable function")
    {
        auto myf = [](std::vector<int> const& id) -> CT {
    ...
    SECTION("polynomial function - check isDone")
    {
        ...
        auto myf = [n](std::vector<int> const& id) -> CT {
            CT x = CT(T(id[0]) / T(n-1)), y = CT(T(id[1]) / T(n-1));
...
// CTensorCI1 Tests
// ============================================================
TEST_CASE("CTensorCI1 continuous - dd128", "[ci1][continuous]")
{
...
TEST_CASE("CTensorCI1 continuous - complex dd128", "[ci1][continuous]")
{
    SECTION("polynomial function directly")
    {
...
// CTensorCI2 Tests
// ============================================================
TEST_CASE("CTensorCI2 continuous - dd128", "[ci2][continuous]")
{
    SECTION("polynomial function directly")
    {
        auto f = [](const std::vector<T>& xs) -> T {
...
TEST_CASE("CTensorCI2 continuous - complex dd128", "[ci2][continuous]")
{
    SECTION("polynomial function directly")
    {
        auto f = [](const std::vector<CT>& xs) -> CT {
