...
// CI1 Tests
// ============================================================
TEST_CASE("TensorCI1 basic - float128", "[ci1]")
{
...
TEST_CASE("TensorCI1 basic - complex float128", "[ci1]")
{
    SECTION("rank-1 separable function")
    {
...
// CI2 Tests
// ============================================================
TEST_CASE("TensorCI2 basic - float128", "[ci2]")
{
    SECTION("rank-1 separable function")
    {
        auto myf = [](std::vector<int> const& id) -> T {
...
TEST_CASE("TensorCI2 basic - complex float128", "[ci2]")
{
    SECTION("rank-1 separable function")
    {
        auto myf = [](std::vector<int> const& id) -> CT {
...
// CTensorCI1 Tests
// ============================================================
TEST_CASE("CTensorCI1 continuous - float128", "[ci1][continuous]")
{
...
TEST_CASE("CTensorCI1 continuous - complex float128", "[ci1][continuous]")
{
    SECTION("polynomial function directly")
    {
...
// CTensorCI2 Tests
// ============================================================
TEST_CASE("CTensorCI2 continuous - float128", "[ci2][continuous]")
{
    SECTION("polynomial function directly")
    {
        auto f = [](const std::vector<T>& xs) -> T {
...
TEST_CASE("CTensorCI2 continuous - complex float128", "[ci2][continuous]")
{
    SECTION("polynomial function directly")
    {
        auto f = [](const std::vector<CT>& xs) -> CT {
